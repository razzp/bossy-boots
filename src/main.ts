...
export { assertIsNotInstanceOf } from './assertions/instance/assertIsNotInstanceOf';
...
export { isInstanceOf } from './guards/instance/isInstanceOf';
export { isNotInstanceOf } from './guards/instance/isNotInstanceOf';
